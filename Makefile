...
fix-lint: ## fix lint issues using autoflake, autopep8, and isort
	find water -name '*.py' | xargs autoflake --in-place --remove-all-unused-imports --remove-unused-variables
	autopep8 --in-place --recursive --aggressive water
	isort --apply --atomic --recursive water
...
coverage: ## check code coverage quickly with the default Python
	coverage run --source water -m pytest
	coverage report -m
	coverage html
...
docs: clean-docs ## generate Sphinx HTML documentation, including API docs
	sphinx-apidoc --module-first --separate -o docs/api/ water
	$(MAKE) -C docs html
